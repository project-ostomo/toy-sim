...
use super::*;
use toy_sim_model::{Id, ProgramQuery, ProgramReply, wasm_intel, wasm_world::ReplyCapacity};
use toy_sim_ship_api::world_intel as a;
...
fn tracks(caller: &mut Caller<'_, Host>, output: u32, arena: u32, page: u32) -> CallResult {
    ...
    let header = a::TrackPage {
        ...
        completion: match result.completion {
            toy_sim_model::Completion::Complete => 0,
            toy_sim_model::Completion::ResultLimit => 1,
            toy_sim_model::Completion::WorkLimit => 2,
        },
