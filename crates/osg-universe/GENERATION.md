...
Run `cargo test -p osg-universe --lib`. Tests cover complete-map validation,
...
Run `cargo run --release -p osg-universe --example generation_benchmark` to
...
Run `cargo run -p osg-universe --example surface_preview -- --benchmark`
