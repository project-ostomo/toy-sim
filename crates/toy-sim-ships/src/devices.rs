...
pub enum DeviceReading {
    ...
    Weapon(toy_sim_ship_api::abi::WeaponReading),
    Accelerometer {
...
impl From<&DeviceDescriptor> for toy_sim_ship_api::abi::DeviceInfo {
    fn from(device: &DeviceDescriptor) -> Self {
        Self {
            ...
            alias: toy_sim_ship_api::abi::Text64::new(&device.alias),
...
impl DeviceStatus {
    pub fn abi_record(&self) -> Vec<u8> {
        use toy_sim_ship_api::abi::{self as abi, Record};
