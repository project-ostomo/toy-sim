...
cargo build -p toy-sim-example-controller --release --target wasm32-unknown-unknown --no-default-features --example chatter --offline
...
cp "$firmware_target"/wasm32-unknown-unknown/release/examples/chatter.wasm crates/toy-sim-ships/data/chatter-controller.wasm
