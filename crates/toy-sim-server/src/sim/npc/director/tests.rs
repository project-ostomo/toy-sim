...
use toy_sim_model::industry::{CargoItem, IndustrySubscription};
use toy_sim_ships::{Catalogue, ShipBlueprint};
...
impl Fixture {
    fn new() -> Self {
        ...
        let profile = &toy_sim_universe::organizations::catalogue()[0];
        ...
        world
            ...
            .0
            .insert_item(
                &CargoItem::Resource(toy_sim_ships::industry::METALS.into()),
                10_000_000,
                capacity,
                &catalogue,
            )
...
fn scheduler_admits_only_one_due_organization_per_tick() {
    ...
    second.organization = Id(toy_sim_universe::organizations::catalogue()[1].id());
    fixture
        .world
        .resource_mut::<Directory>()
        .0
