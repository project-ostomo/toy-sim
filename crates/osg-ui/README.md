...
`osg-ui` owns the workspace's egui integration, theme, fonts and reusable
...
renderer lives in `osg-ship-view` and has no egui dependency.
...
The client implementation is in [ui/shell](../osg-client/src/ui/shell.rs).
