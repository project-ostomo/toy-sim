...
use bevy::math::DVec3;
use bevy::prelude::*;
use osg_intel::{Measurement, Snapshot};
use osg_model::{Id, InfoGroupKey, PUBLIC_GROUP, Pose, Provenance, Tag, Track};
use std::{
...
mod celestial_acquisition_tests {
    ...
    fn celestial_ephemerides_do_not_create_public_sensor_measurements() {
        ...
        let body = osg_universe::example_config().bodies.remove(0);
        app.world_mut().spawn((
            Identity(Id::new()),
