...
pub fn window(
    ...
    egui::Window::new("Universe")
        ...
        .show(contexts.ctx_mut()?, |ui| {
            ...
            ui.label("Skybox: 2048 px/face");
            ui.label(format!("Last CPU bake: {:.3} ms", field.last_seconds * 1000.0));
            ui.add(
            ...
            ui.small("CPU sky bakes at 2048 px/face. Stale bakes are cancelled. Rotation reuses the cache. Sensors only see active bodies.");
