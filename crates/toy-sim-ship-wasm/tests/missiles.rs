...
use toy_sim_ship_wasm::{CallbackKind, Controller, ControllerRuntime, FUEL_PER_TICK, Input};
...
fn missile_and_ship_share_memory_while_suspended_callbacks_keep_their_identity() {
    let imports = r#"
        (import "ship_v31" "missile_read" (func $read (param i32 i32) (result i32)))
        (import "ship_v31" "missile_control" (func $control (param i32 i32) (result i32)))
        (import "ship_v31" "persistent_write" (func $save (param i32 i32) (result i32)))
    "#;
